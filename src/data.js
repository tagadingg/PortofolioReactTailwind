...
export const listProyek = [
  ...
  },
  {
    id: 2,
    gambar: Proyek2,
    nama: "Website Dashboard Kedai Kopi - Belajar Mandiri",
  ...
  },
  {
    ...
    gambar: Proyek5,
    nama: "NEUCAFE",
    desk: "Aplikasi web untuk memantau dan menganalisis informasi statistik penjualan kafe secara efisien. Saya berkontribusi pada desain antarmuka pengguna (UI) Neucafe menggunakan Figma.",
  ...
  },
  {
    ...
    gambar: Proyek6,
    nama: "medRemind",
    desk: "Aplikasi Android yang membantu pengguna mengingat jadwal minum obat secara teratur. Saya berperan dalam membuat desain antarmuka pengguna (UI), serta pengembangan frontend menggunakan Kotlin.",
    tools: ["Kotlin", "Figma"],
    dad: "700",
